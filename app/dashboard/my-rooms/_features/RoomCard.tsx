        ...
        <Card className='w-full p-2 flex flex-row items-center justify-between gap-2 md:hover:bg-gray-100 duration-200 border-gray-300'>
            <div className='flex justify-center items-center gap-4 w-9/10'>
                <Image                
                    ...
                    width={70}
                    height={70}
                    className="rounded-lg p-2 aspect-square outline-1 outline-primary-300 bg-linear-to-tr from-secondary-100 to-primary-100"
                />
                <div className='min-w-0 flex-1'>
                    <h2 className='text-lg md:text-xl font-semibold whitespace-nowrap text-ellipsis min-w-0 overflow-hidden'>{room.name}</h2>
