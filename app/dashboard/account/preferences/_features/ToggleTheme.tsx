    ...
    return (
        <div className='flex flex-col items-start gap-2'>
            ...
            <div className='flex flex-col md:flex-row items-center gap-2 w-full'>
                ...
                <div onClick={() => setTheme('system')} className={`flex flex-col border-2 w-full md:w-1/3 border-gray-200 dark:border-gray-800 items-center gap-2 px-12 py-6 rounded-lg cursor-pointer ${theme === 'system' ? 'bg-primary-50 dark:bg-gray-800 border-primary-300 dark:border-primary-500' : ''}`}>
