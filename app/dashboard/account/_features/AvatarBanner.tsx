...
export default function AvatarBanner({ user, subscription }: AvatarBannerProps) {
    ...
    return (
        <MotionDiv
            ...
            className='w-full flex flex-col items-center justify-center px-4 pt-12 pb-4 bg-linear-to-bl from-secondary-100 to-primary-100 border-gray-200 border rounded-lg'>
