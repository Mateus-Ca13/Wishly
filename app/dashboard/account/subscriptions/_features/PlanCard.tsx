        ...
        <MotionDiv
            ...
            <div
                ...
                <div className='flex flex-col items-start justify-start text-start my-2'>
                    <p className='text-3xl md:text-4xl text-gradient font-semibold'>R$ {formatPrice(plan.price)}<span className='text-lg md:text-xl text-black dark:text-white ms-1'>/ mês</span></p>
                ...
                <div>
                    <div className='flex items-center justify-start text-start gap-2'>
                        ...
                        <p className='text-sm md:text-base text-gray-500 dark:text-white'><span className='font-semibold text-primary-500'>{plan.max_rooms > 100 ? 'Ilimitadas' : plan.max_rooms}</span> salas</p>
                    </div>
                    <div className='flex items-center justify-start text-start gap-2'>
                        <Check className='text-green-500 size-4' />
                        <p className='text-sm md:text-base text-gray-500 dark:text-white'><span className='font-semibold text-primary-500'>{plan.max_members_per_room > 100 ? 'Ilimitados' : plan.max_members_per_room}</span> membros por sala</p>
                    </div>
                    <div className='flex items-center justify-start text-start gap-2'>
                        <Check className='text-green-500 size-4' />
                        <p className='text-sm md:text-base text-gray-500 dark:text-white'><span className='font-semibold text-primary-500'>{plan.max_items_per_wishlist > 100 ? 'Ilimitados' : plan.max_items_per_wishlist}</span> itens por lista</p>
                    </div>
                    {premium && <div className='flex items-center justify-start text-start gap-2'>
                        <Check className='text-green-500 size-4' />
                        <p className='text-sm md:text-base text-gray-500 dark:text-white'><span className='font-semibold text-primary-500'>Notificações</span> personalizadas</p>
                    </div>}
                </div>
