...
import GuestWishlistContainer from "./GuestWishlistContainer";

type GuestWishlistDataLoaderProps = {
    slug: string
}

export default async function GuestWishlistDataLoader({ slug }: GuestWishlistDataLoaderProps) {
